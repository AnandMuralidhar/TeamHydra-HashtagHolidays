	...
	<div class="registerform">
		...
		<form method="POST" class="form-horizontal" action="/addCompany">
				...
				<br /><br />	<input type="password" id="pwd"
						placeholder="Enter password" name="pwd" required><br /><br />
					<input type="text" id="cname"
						placeholder="Enter Company Name" name="cname"></br></br>
					<div style="margin-left: 33%;">
					<button type="submit" class="submitbtn">Register</button>
					<p class="submitbtn" style="width: 18%;"><a style="color: #FFFFFF;" href="/loginPage">Cancel</a></p>
		</div>
		</form>
	</div>
	</div>
