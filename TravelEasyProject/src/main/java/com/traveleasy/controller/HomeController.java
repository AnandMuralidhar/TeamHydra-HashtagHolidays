...
public class HomeController {
	...
	public String getData(HttpSession session, ModelMap model) {
		...
		if (Travelplans.isEmpty()) {
			...
			session.setAttribute("errorMessage",
					"Sorry we currently don't have any plans for " + lexCountry + " in the month of " + lexMonth + "!");
			return "redirect:/errorPage";
		} else {
	 ...
	 * logout(ModelMap model, HttpSession session) { String id_token = (String)
	 * session.getAttribute("id_token"); if (id_token != null) { try {
	 * GoogleIdToken.Payload payLoad =
	 * IdTokenVerifierAndParser.getPayload(id_token); if (payLoad != null) {
	 ...
	 */
	@PostMapping("/adduser")
	public String adduser(@RequestParam("fname") String fname, @RequestParam("username") String username,
	...
	public String postReview(@RequestPart(value = "reviewimage") MultipartFile reviewimage,
			@RequestParam("username") String username, @RequestParam("plan") String plan,
